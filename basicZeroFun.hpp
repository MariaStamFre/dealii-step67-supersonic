 ...
 */
double
regulaFalsi(std::function<double(double)> const &f, double a, double b, double tol = 1.e-6,
            double tola = 1.e-10)
{
  double ya = f(a);
  double yb = f(b);
 ...
 */
double
bisection(std::function<double(double)> const &f, double a, double b, double tol = 1.e-5)
{
  double ya = f(a);
  double yb = f(b);
  double delta = b - a;
...
secant(std::function<double(double)> const &f, double a, double b, double tol = 1e-6,
       double tola = 1.e-12, unsigned int maxIt = 5000)
{
  double       ya = f(a);
 ...
 */
std::tuple<double, bool>
Newton(std::function<double(double)> const &f, std::function<double(double)> const & df, double a, double tol = 1e-4,
...
bracketInterval(std::function<double(double)> const &f, double x1, double h = 0.01,
 ...
 */
std::tuple<double, bool>
brent_search(const std::function<double(double)> &f, double a, double b, double tol = 1.e-5,
